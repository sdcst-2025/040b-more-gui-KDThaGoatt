...
button8 = tk.Button(window, text="NW", width=3, height=1, borderwidth=2, relief="groove")
button9 = tk.Button(window, text="N", width=3, height=1, borderwidth=2, relief="raised")
button10 = tk.Button(window, text="NE", width=3, height=1, borderwidth=2, relief="groove")
...
button13 = tk.Button(window, text="SW", width=3, height=1, borderwidth=2, relief="groove")
button14 = tk.Button(window, text="S", width=3, height=1, borderwidth=2, relief="raised")
button15 = tk.Button(window, text="SE", width=3, height=1, borderwidth=2, relief="groove")
